...
public class ImporterTempOccurrences extends ImporterBase {
     ...
     */
    public ImporterTempOccurrences(String filePath, String fileSplit, boolean clean, String log) throws Exception
    {        
        ...
        try {
            ...
            throw new Exception("Error in load temp_occurrences in the database " + ex);
        } catch (Exception ex) {
            throw new Exception("Error in load temp_occurrences " + ex);
        }
    }
