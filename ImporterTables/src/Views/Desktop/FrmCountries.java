...
public class FrmCountries extends javax.swing.JDialog {
    /*Member class*/
    private RepositoryCountry rCountry;
    ...
    private void load()
    {
        ...
        for(int i=0;i<rows;i++)
            model.removeRow(0);
        fillTable(rCountry.list());
    }
    
    /**
     * Method that fill table with countries
     * @param countries 
     */
    private void fillTable(ArrayList<Country> countries)
    {
        ...
        for(int i=0;i<countries.size();i++)
            model.addRow(new Object[]{countries.get(i).getId(),countries.get(i).getName(),countries.get(i).getIso2(),countries.get(i).getIso3()});
    }
    
    /**
     * Get country type in the text field
     * @return 
     */
    private Country getCountryFields()
    {
        return new Country(0,txtName.getText(), txtIso2.getText(), txtIso3.getText());
    }
    
    /**
     * Get country from selected row
     * @return 
     */
    private Country getCountrySelected()
    {
        int row=tblCountries.getSelectedRow();
        return new Country(Integer.parseInt(tblCountries.getValueAt(row, 0).toString()), tblCountries.getValueAt(row, 1).toString(), tblCountries.getValueAt(row, 2).toString(),tblCountries.getValueAt(row, 2).toString());
    }
    ...
    private void cmdInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdInsertActionPerformed
        ...
        try
        {
            if(rCountry.insert(getCountryFields()) > 0)
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        ...
        try
        {
            if(rCountry.delete(getCountrySelected()) > 0)
